# Contributing to marp-gh-page-action
...
In short, when you submit code changes, your submissions are understood to be under the same [MIT License](https://github.com/timo-reymann/timo-reymann/marp-gh-page-action/blob/main/LICENSE) that covers the project. Feel free to contact the maintainers if that's a concern.
